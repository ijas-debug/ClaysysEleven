...
function validateInput(input) {
    ...
    if (!/^[a-zA-Z]+$/.test(value)) {
        errorMessageElement.textContent = "Please enter only alphabetic characters.";
        errorMessageElement.classList.add("error-message3");
    } else {
        errorMessageElement.textContent = "";
        errorMessageElement.classList.remove("error-message3");
    }
}
